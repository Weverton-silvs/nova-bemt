                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-12">
                                            ...
                                            <?php
                                                          ...
                                                          $insert = "INSERT INTO tb_valores (titulo1,texto1) VALUES (:titulo,:subtitulo)";
                                                          try {
                                                      ...
                                                      <div class="table-responsive table-hover">
                                                          <table class="table">
                                                              ...
                                                              <tbody>
                                                                <?php
                                                                      //INICIO
                                                                      $selectslide = 'SELECT * FROM tb_valores ORDER BY id_val DESC LIMIT 3';
                                                                      $contador = 1;
                                                                      try{
                                                                      ...
                                                                      ?>
                                                                  <tr>
                                                                      <th scope="row"><?php echo $mostrar ->id_val;?></th>
                                                                      <td><?php echo $mostrar ->titulo1;?></td>
                                                                      <td><?php echo $mostrar ->texto1;?></td>
                                                                      <td class="icon-btn">
                                                                        <a href="home.php?acaoadmin=attval&idUp=<?php echo $mostrar ->id_val;?>" class="btn btn-success btn-icon" title="Editar"><i class="fa fa-pencil-square-o"style="text-align:center"></i></a>
