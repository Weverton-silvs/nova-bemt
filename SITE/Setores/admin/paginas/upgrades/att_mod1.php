                                    ...
                                    //echo $id;
                                    $select = "SELECT * FROM tb_mod1 Where id_mod1 = :id ";
                                    try{
                                ...
                                //INFO IMAGEM
                                            ...
                                            $novoNome = $img;
                                                ...
                                                //QUERY DE UPDATE
                                        $update = "UPDATE tb_mod1 SET img=:foto,titulo=:titulo,descricao=:descricao,observacao=:obs WHERE id_mod1 =:id";
                                        try{
                                          ...
                                          if ($contar>0) {
                                                  ...
                                                  <form method="post" action="" enctype="multipart/form-data">
                                                      ...
                                                      <div class="form-group row">
                                                          ...
                                                          <label class="col-sm-2 control-label" for="arquivo"><img src="imgAdmin/MOD1/<?php echo $novoNome;?>" style="width:100%;" alt=""></label>
                                                      </div>
                                                      <div class="form-group row">
                                                      ...
                                                      <div class="table-responsive table-hover">
                                                          <table class="table">
                                                              ...
                                                              <tbody>
                                                                ...
                                                                <?php
                                                                      //INICIO
                                                                      $selectslide = 'SELECT * FROM tb_mod1 ORDER BY id_mod1 DESC LIMIT 1';
                                                                      $contador = 1;
                                                                      try{
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td><img src="imgAdmin/MOD1/<?php echo $novoNome;?>" style="width: 100px
                                          														;"alt=""></td>
                                                                      <td><?php echo $titulo;?></td>
                                                                      <td><?php echo $desc;?></td>
                                                                      <td><?php echo $obs;?></td>
                                                                      <td class="icon-btn">
                                                                      <button class="btn btn-info btn-icon" ><a  style="color:#fff" href="home.php?acaoadmin=cadmod1"title="Voltar"><i class="fa fa-reply"style="text-align:center"></i></a></button>
                                                                        <button class="btn btn-danger btn-icon"><a style="color:#fff" href="paginas/delete/delPaginas.php?idDelmod1=<?php echo $mostrar ->id_mod1;?>"  title="Deletar"><i class="fa fa-trash"></i></a></button>
