                                    ...
                                    //echo $id;
                                    $select = "SELECT * FROM tb_apresentacao WHERE id_apresentacao = :id ";
                                    try{
                                      ...
                                      if($contar > 0){
                                        while ($show = $resultado->FETCH(PDO::FETCH_OBJ)) {
                                          $id = $show->id_apresentacao;
                                          $titulo = $show->titulo1_apr;
                                          $subtitulo = $show->subtitulo1_apr;
                                    ...
                                    $update = "UPDATE tb_apresentacao SET titulo1_apr=:titulo,subtitulo1_apr=:subtitulo WHERE id_apresentacao =:id";
                                    try{
                                                      ...
                                                      <div class="table-responsive table-hover">
                                                          <table class="table">
                                                              ...
                                                              <tbody>
                                                                <?php
                                                                      //INICIO
                                                                      $selectslide = 'SELECT * FROM tb_apresentacao ORDER BY id_apresentacao DESC LIMIT 1';
                                                                      $contador = 1;
                                                                      try{
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td class="icon-btn">
                                                                        <a href="home.php?acaoadmin=cadsobre"class="btn btn-info btn-icon" title="Voltar"><i class="fa fa-reply"style="text-align:center"></i></a>
                                                                        <a href="paginas/delete/delPaginas.php?idDelsobre=<?php echo $mostrar ->id_apresentacao;?>" class="btn btn-danger btn-icon" title="Deletar"><i class="fa fa-trash"></i></a>
