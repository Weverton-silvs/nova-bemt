                                    ...
                                    //echo $id;
                                    $select = "SELECT * FROM tb_geren Where id_geren = :id ";
                                    try{
                                ...
                                //INFO IMAGEM
                                            ...
                                            $novoNome = $img;
                                                ...
                                                //QUERY DE UPDATE
                                        $update = "UPDATE tb_geren SET img=:foto,titulo=:titulo,descricao=:descricao,observacao=:obs WHERE id_geren =:id";
                                        try{
                                          ...
                                          if ($contar>0) {
                                                  ...
                                                  <form method="post" action="" enctype="multipart/form-data">
                                                      ...
                                                      <div class="form-group row">
                                                          ...
                                                          <label class="col-sm-2 control-label" for="arquivo"><img src="imgAdmin/Gerencia/<?php echo $novoNome;?>" style="width:100%;" alt=""></label>
                                                      </div>
                                                      <div class="form-group row">
                                                      ...
                                                      <div class="table-responsive table-hover">
                                                          <table class="table">
                                                              ...
                                                              <tbody>
                                                                ...
                                                                <?php
                                                                      //INICIO
                                                                      $selectslide = 'SELECT * FROM tb_geren ORDER BY id_geren DESC LIMIT 1';
                                                                      $contador = 1;
                                                                      try{
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td><img src="imgAdmin/Gerencia/<?php echo $novoNome;?>" style="width: 100px
                                          														;"alt=""></td>
                                                                      <td><?php echo $titulo;?></td>
                                                                      <td><?php echo $desc;?></td>
                                                                      <td><?php echo $obs;?></td>
                                                                      <td class="icon-btn">
                                                                      <button class="btn btn-info btn-icon"><a style="color:#fff" href="home.php?acaoadmin=cadgeren" title="Voltar"><i class="fa fa-reply"style="text-align:center"></i></a></button>
                                                                        <button class="btn btn-danger btn-icon"><a style="color:#fff"href="paginas/delete/delPaginas.php?idDelgeren=<?php echo $mostrar ->id_geren;?>"  title="Deletar"><i class="fa fa-trash"></i></a></button>
