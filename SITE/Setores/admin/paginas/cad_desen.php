                                                            ...
                                                            elseif(!in_array($type,$permite))
                                                              ...
                                                              $msg[] = "<b>$name :</b> Erro imagem ultrapassa o limite de 2MB";
                                                                ...
                                                                if (move_uploaded_file($tmp,$folder.'/'.$novoNome)) {
                                                                  ...
                                                                  $cadUser = "INSERT INTO tb_desen (img,titulo,descricao,observacao) VALUES (:avatar,:titulo,:descricao,:obs)";
                                                                  try {
                                                      ...
                                                      <div class="table-responsive table-hover">
                                                          <table class="table">
                                                              ...
                                                              <tbody>
                                                                ...
                                                                <?php
                                                                      //INICIO
                                                                      $selectslide = 'SELECT * FROM tb_desen ORDER BY id_desen DESC LIMIT 3';
                                                                      $contador = 1;
                                                                      try{
                                                                      ...
                                                                      ?>
                                                                  <tr>
                                                                      <th scope="row"><?php echo $mostrar ->id_desen;?></th>
                                                                      <td><img src="imgAdmin/Desenvolvimento/<?php echo $mostrar ->img;?>" style="width: 100px
                                          														;"alt=""></td>
                                                                      <td><?php echo $mostrar ->titulo;?></td>
                                                                      <td><?php echo $mostrar ->descricao;?></td>
                                                                      <td><?php echo $mostrar ->observacao;?></td>
                                                                      <td class="icon-btn">
                                                                        <button class="btn btn-success btn-icon"><a style="color:#fff"  href="home.php?acaoadmin=attdesen&idUp=<?php echo $mostrar ->id_desen;?>"  title="Editar"><i class="fa fa-pencil-square-o"style="text-align:center"></i></a></button>
