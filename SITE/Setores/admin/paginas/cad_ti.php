                                                            ...
                                                            elseif(!in_array($type,$permite))
                                                              ...
                                                              $msg[] = "<b>$name :</b> Erro imagem ultrapassa o limite de 2MB";
                                                                ...
                                                                if (move_uploaded_file($tmp,$folder.'/'.$novoNome)) {
                                                                  ...
                                                                  $cadUser = "INSERT INTO tb_ti (img,titulo,descricao,observacao) VALUES (:avatar,:titulo,:descricao,:obs)";
                                                                  try {
                                                      ...
                                                      <div class="table-responsive table-hover">
                                                          <table class="table">
                                                              ...
                                                              <tbody>
                                                                ...
                                                                <?php
                                                                      //INICIO
                                                                      $selectslide = 'SELECT * FROM tb_ti ORDER BY id_ti DESC LIMIT 3';
                                                                      $contador = 1;
                                                                      try{
                                                                      ...
                                                                      ?>
                                                                  <tr>
                                                                      <th scope="row"><?php echo $mostrar ->id_ti;?></th>
                                                                      <td><img src="imgAdmin/TI/<?php echo $mostrar ->img;?>" style="width: 100px
                                          														;"alt=""></td>
                                                                      <td><?php echo $mostrar ->titulo;?></td>
                                                                      <td><?php echo $mostrar ->descricao;?></td>
                                                                      <td><?php echo $mostrar ->observacao;?></td>
                                                                      <td class="icon-btn">
                                                                        <button class="btn btn-success btn-icon"><a style="color:#fff" href="home.php?acaoadmin=attti&idUp=<?php echo $mostrar ->id_ti;?>"  title="Editar"><i class="fa fa-pencil-square-o"style="text-align:center"></i></a></button>
                                                                        <button class="btn btn-danger btn-icon"><a style="color:#fff" href="paginas/delete/delPaginas.php?idDelti=<?php echo $mostrar ->id_ti;?>"  title="Deletar"><i class="fa fa-trash"></i></a></button>
