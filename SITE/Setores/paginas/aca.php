                                          ...
                                          <div class="col-lg-12">
                                            <div class="card">
                                              <div class="card-block">
                                                  <h4 class="sub-title">Acabamento</h4>
                                                </div> 
                                                <div class="col-lg-12">
                                                <?php
                                                                      //INICIO
                                                                      $select = 'SELECT * FROM tb_acabamento ORDER BY id DESC LIMIT 1';
                                                                      $contador = 1;
                                                                      try{
                                                                      ...
                                                                      ?>
                                                                      <img src="admin/imgAdmin/Acabamento/<?php echo $mostrar -> img;?>" alt="" style="width:100%;
                                                                      heigth: 100px;">
                                                                      <?php
                                                                          //FIM
                                                                          }
